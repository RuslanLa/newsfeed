    ...
    switch (param.tag | 0) {
      ...
      case 6 : 
          ...
          if (match$15[0] >= 826472012) {
            ...
            return expect(match$16[0]).toBeCloseTo(match$16[1], Js_undefined.from_opt(match$16[2]));
          } else {
            var match$17 = match$15[1];
            return expect(match$17[0]).not.toBeCloseTo(match$17[1], Js_undefined.from_opt(match$17[2]));
          }
      case 7 : 
